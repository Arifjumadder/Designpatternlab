...
interface UpdateProductSrv  {
    ...
    void decissionmaker(userType,password);
...
class LoginAsadmin implements UpdateProductSrv{
	public void decissionmaker(userType,password){
				response.sendRedirect("login.jsp?message=Access Denied, Login As Admin!!");
			
	}
}

class errorLogin implements UpdateProductSrv{
	public void decissionmaker(userType,password){
